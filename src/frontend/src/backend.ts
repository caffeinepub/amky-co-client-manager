...
export class Backend implements backendInterface {
    ...
    async addClient(arg0: ClientInput): Promise<void> {
    ...
    async editClient(arg0: ClientId, arg1: ClientInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.editClient(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
